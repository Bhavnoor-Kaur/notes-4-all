    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='notes4all.customers')),
                ('product', models.ManyToManyField(to='notes4all.Products')),
            ],
        ),
    ]
